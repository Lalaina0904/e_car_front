        ...
        <div className="grid grid-cols-4">
          <div className="col-span-3 mr-10">
            ...
            <div>
              ...
              <p>
                BMW has really made a mark in the electric car market, and the
                iX2 is the latest addition to its EV stable. As with the
                petrol-powered X2, it’s based on the same mechanical package as
                the iX1 electric SUV, but gets sharper exterior styling that
                comes a little at the expense of practicality.
              </p>
            </div>
          </div>
          {/* --- */}
          <div className="col-span-1">
            <div>
              <h2 className="text-xl font-semibold text-slate-700">Featured</h2>
              ...
              <div>
                ...
                <p className="font-semibold text-sm">News 2024</p>
                <p>Jeep Wagoneer S Up Close: Reimagining the Trackhawk</p>
              </div>
            </div>
            <div>
              <h2 className="text-xl font-semibold text-slate-700">

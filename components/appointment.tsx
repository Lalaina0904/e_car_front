      ...
      <div>
            ...
            <div className="flex justify-between items-center bg-white p-5 rounded-xl shadow-xl">
                ...
                <div className="flex flex-col gap-2">
                    <Button className="bg-[#013248] uppercase" onClick={()=>handleStatus(appointment.id,"update")}>validé</Button>
                    <Button className="bg-[#ac1e1e] uppercase" onClick={()=>handleStatus(appointment.id,"refuse")}>refusé</Button>
                </div>
            </div>
        </div>
    )
